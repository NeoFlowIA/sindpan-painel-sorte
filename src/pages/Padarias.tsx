        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">94% do total</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-secondary">R$ 42,85</div>
              ...
              <TableBody>
                {bakeries.map((bakery, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="max-w-xs truncate">{bakery.address}</TableCell>
                    <TableCell>{bakery.responsible}</TableCell>
